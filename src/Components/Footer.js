  ...
  return (
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="footer-column">
          <p className="ft-title">
            Clean<span className="ft-sign">ify</span>
          </p>
          <p className="ft-description">
            Cleanify brings you spotless living with professional house
            cleaning services designed for comfort, hygiene, and peace of mind.
            Experience a cleaner, brighter home — effortlessly.
          </p>
        </div>
        ...
        <div className="footer-column">
          ...
          <ul className="ft-list-items">
            ...
            <li><a href="#services">Sofa & Carpet</a></li>
        ...
        <div className="footer-column">
          ...
          <ul className="ft-list-items">
            <li><a href="mailto:support@cleanify.com">support@cleanify.com</a></li>
      ...
      <div className="ft-bottom">
        <p>© 2025 Cleanify. All rights reserved.</p>
